...
//    }
    ...
    @IBAction func submitActionForRideCancel(_ sender: Any) {
        ...
        if !isDriverTakingTooLongSelected && !isRideAmountTooHighSelected && !isBookMyMistakeSelected {
            ...
            if cancelReasonView.isHidden == false {
                cancelReasonView.isHidden = true
            }
            if self.driverDetailsView.isHidden == false {
                self.driverDetailsView.isHidden = true
            ...
            buttonOpticity1.isHidden = false
            loaderActivity1.isHidden = false
            loaderActivity1.startAnimating()
            cancelRide()
        }
    }
...
//                                    mapView.delegate = nil
    ...
    func cancelRide() {
        ...
        //        if driverDetailsView.isHidden == false && cancelBtnIsCalledFrom == "After Driver Accepted the Ride" {
        ...
        let params :  [String : Any] = [
            //            "fk_bookride_id": 6
            //            "fk_bookride_id": (pkbookrideid == 0) ? self.pk_bookride_id ?? 0 : pkbookrideid ?? 0,
            "fk_bookride_id": pkbookrideid,
